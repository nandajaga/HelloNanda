...
public class ClarityExample {
	//public static void main(String[] args) throws Exception{
		...
		/*String service = "src\\com\\drivers\\IEDriverServer.exe";
		System.setProperty("webdriver.ie.driver", service);
		DesiredCapabilities ieCapabilities = DesiredCapabilities.internetExplorer();
        ieCapabilities.setCapability(InternetExplorerDriver.INTRODUCE_FLAKINESS_BY_IGNORING_SECURITY_DOMAINS,true);
		InternetExplorerDriver  driver = new InternetExplorerDriver(ieCapabilities);*/
		@DataProvider
		public Object[][] DataClarity() throws Exception{
			  
			  Object[][] retObjArr= com.ecxel.Excel.getTableArray("src/dataprovider/DataTemp.xls", "Sheet1", "DataClarity");
			  System.out.println(retObjArr);			 
			  return(retObjArr);
		  };
		@Test(dataProvider = "DataClarity") 
		public void DataClarity(String UN, String PWD) throws InterruptedException{
		...
		driver.findElement(By.id("ppm_login_username")).sendKeys(UN);
		
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		driver.findElement(By.id("ppm_login_password")).sendKeys(PWD);
