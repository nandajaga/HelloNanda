...
public class NewTest {
  ...
  @Test(dataProvider = "DataCelsiusToFahrenheit")
  public void f(String temp, String Exp) {
	  ...
	  System.out.println(Exp);
		...
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		driver.findElement(By.id("ppm_login_password")).sendKeys(Exp);
  ...
  @DataProvider
  public Object[][] DataCelsiusToFahrenheit() throws Exception {
	  Object[][] retObjArr= com.parameterization.Excel.getTableArray("src/dataprovider/DataTemp.xls", "Sheet1", "DataCelsiusToFahrenheit");
	return retObjArr;
    };
  }
